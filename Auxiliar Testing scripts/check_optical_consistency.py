...
FNAME = "ism_toa_optical_{band}.nc"

THRESH_PCT = 0.01      # 0.01% tolerance
PASS_FRAC  = 0.9973    # 99.73% of pixels
...
def load2d(path):
    ...
    arr = ds[var].values
    ds.close()
    # expected shape: (ALT, ACT) after optical stage
...
if __name__ == "__main__":
    print("=== OPTICAL CONSISTENCY VALIDATION (ism_toa_optical) ===\n")
    fracs = []
    for b in BANDS:
